...
var AddressSuggestions = /** @class */ (function (_super) {
    ...
    function AddressSuggestions() {
        ...
        _this.renderOption = function (suggestion) {
            ...
            return renderOption ? renderOption(suggestion) : (react_1.default.createElement(HighlightWords_1.HighlightWords, { highlightClassName: highlightClassName || 'react-dadata--highlighted', words: _this.getHighlightWords(), text: suggestion.value }));
        };
        return _this;
    }
