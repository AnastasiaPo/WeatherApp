...
var HighlightWords = /** @class */ (function (_super) {
    ...
    HighlightWords.prototype.render = function () {
        ...
        return (react_1.default.createElement("span", null, chunks.map(function (chunk) {
            if (!chunk.match) {
                return react_1.default.createElement("span", { key: chunk.key }, chunk.text);
            }
            var Component = tagName;
            return (react_1.default.createElement(Component, { key: chunk.key, className: highlightClassName }, chunk.text));
        })));
    };
